        ...
        <div id="content">
            ...
            <div class="container-fluid">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table action-panel table-bordered" id="dataTable" cellspacing="0">
                                ...
                                <tbody>
                                <c:forEach items="${spare}" var="title">
                                    <tr>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="card shadow mb-4">
                                                    <div class="card-header py-3">
                                                        <h6 class="m-0 font-weight-botext-primary">Umiejętności</h6>
                                                    </div>
                                                    <div class="card-body">
                                                        <h4 class="small
              ...
              font-weight-bold">Hibernate JPA
                                                        ...
                                                        <h4 class="sma font-weight-bold">HTML, CSS
                                                            <span class="float-right">50%</span></h4>
                                                        <div class="progress mb-4">
                                                            <div class="progress-bar bg-info" role="progressbar"
                                                                 style="width: 50%" aria-valuenow="80" aria-valuemin="0"
                                                        ...
                                                        <h4 class="smalfont-weight-bold">JSP
                                                            <span class="float-right">50%</span></h4>
                                                        <div class="progress mb-4">
                                                            <div class="progress-bar bg-info" role="progressbar"
                                                                 style="width: 50%" aria-valuenow="80" aria-valuemin="0"
           ...
           btn-danger pull-left"
            ...
            <div class="card-header py-3">
                ...
                <a href='<c:url value="/addPart"/>' class="btn btn-info btn-icon-split">
