                        ...
                        <div class="col-xl-12 col-md-12 mb-12">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-2 col-form-label">Wybierz Dostawcę</label>
                                        <div class="col-10">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-10">
                                            <input class="form-control" type="text" name="catalogNumber"  placeholder="uzupełnij nr katalogowy">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-2 col-form-label">Nazwa</label>
                                        <div class="col-10">
                                            <input class="form-control" type="text" name="name"  placeholder="uzupełnij nazwe">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-2 col-form-label">Liczba sztuk</label>
                                        <div class="col-10">
                                            <input class="form-control" type="text" name="quantity"  placeholder="uzupełnij ilość sztuk">
                                        </div>
                                    </div>
